...
extern zipFile ZEXPORT CSIIMADP_zipOpen OF((const char *pathname, int append));
/*
  Create a zipfile.
...
extern int ZEXPORT CSIIMADP_zipOpenNewFileInZip2 OF((zipFile file,
                                            const char* filename,
                                            const zip_fileinfo* zipfi,
                                            const void* extrafield_local,
                                            uInt size_extrafield_local,
...
extern int ZEXPORT CSIIMADP_zipOpenNewFileInZip3 OF((zipFile file,
                                            const char* filename,
                                            const zip_fileinfo* zipfi,
                                            const void* extrafield_local,
                                            uInt size_extrafield_local,
...
/*
  Same than CSIIMADP_zipOpenNewFileInZip2, except
...
extern int ZEXPORT CSIIMADP_zipWriteInFileInZip OF((zipFile file,
                       const void* buf,
                       unsigned len));
/*
...
extern int ZEXPORT CSIIMADP_zipCloseFileInZip OF((zipFile file));
/*
  Close the current file in the zipfile
*/

extern int ZEXPORT CSIIMADP_zipCloseFileInZipRaw OF((zipFile file,
                                            uLong uncompressed_size,
                                            uLong crc32));
/*
  Close the current file in the zipfile, for fiel opened with
    parameter raw=1 in CSIIMADP_zipOpenNewFileInZip2
  uncompressed_size and crc32 are value for the uncompressed size
*/

extern int ZEXPORT CSIIMADP_zipClose OF((zipFile file,
