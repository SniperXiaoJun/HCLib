...
typedef void(^JRMMPopupInputHandler)(NSString *text);

@interface JRMMAlertView : JRMMPopupView
...
/**
 *  Global Configuration of JRMMAlertView.
 */
@interface JRMMAlertViewConfig : NSObject
