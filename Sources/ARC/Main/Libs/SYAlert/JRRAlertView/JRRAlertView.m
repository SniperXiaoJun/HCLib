...
@interface JRRAlertView ()

@property (nonatomic,strong)NSArray *themeArray;

@end
@implementation JRRAlertView
...
-(void)setAlertWidth:(CGFloat)width{
    ...
    [self.mainView mas_updateConstraints:^(NickMASConstraintMaker *make) {
        if (width > 1) {
...
//    [self.mainView insertSubview:self.closedButton atIndex:999];
    ...
    [self.mainView mas_makeConstraints:^(NickMASConstraintMaker *make) {
...
//    }];
    [self.headerTitleLabel mas_makeConstraints:^(NickMASConstraintMaker *make) {
    ...
    [self.contentView mas_makeConstraints:^(NickMASConstraintMaker *make) {
...
//    iv.image = [UIImage imageNamed:@"left_line_image"];
//    iv.frame = CGRectMake(self.contentView.frame.origin.x, self.contentView.frame.origin.y, self.contentView.frame.size.width, 2);
...
-(void)simpleAlertViewInitUI{
    ...
    [self.contentTextLabel mas_makeConstraints:^(NickMASConstraintMaker *make) {
...
//    [self.mainView addSubview:self.lineView];
    ...
    [self.confirmButton mas_makeConstraints:^(NickMASConstraintMaker *make) {
...
-(void)cancelAndConfirmAlertViewInitUI{
    ...
    [arrayM mas_distributeViewsAlongAxis:NickMASAxisTypeHorizontal withFixedSpacing:0 leadSpacing:0 tailSpacing:0];
    [arrayM mas_makeConstraints:^(NickMASConstraintMaker *make) {
...
-(UIView*)mainView{
    if (_mainView == nil) {
        ...
        [_mainView.layer setCornerRadius:7];
    }
    return _mainView;
}
...
//        [_confirmButton setBackgroundColor:RGB16(0Xfddb43)];
        ...
        [_confirmButton.titleLabel setFont:[UIFont boldSystemFontOfSize:15]];
        [_confirmButton addTarget:self action:@selector(confirmButtonClick:) forControlEvents:UIControlEventTouchUpInside];
//        // TOMO:Modified By ShenYu
//        UIImageView *view = [[UIImageView alloc] init];
//        [_confirmButton addSubview:view];
//        view.image = [UIImage imageNamed:@"left_line_image"];
//        view.frame = CGRectMake(0, 0, self.superview.frame.size.width, 1);
...
-(UIImageView *)lineView{
    ...
    if(_lineView == nil){
        ...
        _lineView.image = JRBundeImage(@"left_line_image");
...
-(UIButton *)closedButton{
    if(_closedButton == nil){
        ...
        [_closedButton setImage:JRBundeImage(@"closed.png") forState:UIControlStateNormal];
...
-(UILabel*)headerTitleLabel {
    if (_headerTitleLabel == nil) {
        ...
        [_headerTitleLabel setFont:[UIFont boldSystemFontOfSize:15]];
...
-(UILabel*)contentTextLabel {
    if (_contentTextLabel == nil) {
        ...
        [_contentTextLabel setTextColor:[UIColor blackColor]];
