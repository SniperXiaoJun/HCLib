...
@implementation NSObject (CSIIMJKeyValue)
#pragma mark - 公共方法
#pragma mark - 字典转模型
/**
 *  通过JSON数据来创建一个模型
...
{
    CSIIMJAssertParamNotNil2(data, nil);
...
+ (instancetype)objectWithKeyValues:(NSDictionary *)keyValues
{
    ...
    CSIIMJAssert2([keyValues isKindOfClass:[NSDictionary class]], desc, nil);
...
{
    CSIIMJAssertParamNotNil2(filename, nil);
...
{
    CSIIMJAssertParamNotNil2(file, nil);
...
{
    NSString *desc = [NSString stringWithFormat:@"keyValues is not a NSDictionary - keyValues参数不是一个字典, keyValues is a %@ - keyValues参数是一个%@", keyValues.class, keyValues.class];
    CSIIMJAssert2([keyValues isKindOfClass:[NSDictionary class]], desc, );
...
+ (NSArray *)keyValuesArrayWithObjectArray:(NSArray *)objectArray
{
    ...
    CSIIMJAssert2([objectArray isKindOfClass:[NSArray class]], desc, nil);
...
+ (NSArray *)objectArrayWithKeyValuesArray:(NSArray *)keyValuesArray
{
    ...
    CSIIMJAssert2([keyValuesArray isKindOfClass:[NSArray class]], desc, nil);
...
{
    CSIIMJAssertParamNotNil2(propertyName, nil);
    NSString *key = nil;
    // 1.查看有没有需要替换的key
