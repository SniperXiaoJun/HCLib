...
@interface NickLxGridViewFlowLayout : UICollectionViewFlowLayout

@property (nonatomic,assign) BOOL panGestureRecognizerEnable;

@end

@protocol NickLxGridViewDataSource <UICollectionViewDataSource>
...
@protocol NickLxGridViewDelegateFlowLayout <UICollectionViewDelegateFlowLayout>
