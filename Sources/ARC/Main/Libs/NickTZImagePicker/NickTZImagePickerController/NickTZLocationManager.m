...
@interface NickTZLocationManager ()<CLLocationManagerDelegate>
...
@implementation NickTZLocationManager

+ (instancetype)manager {
    static NickTZLocationManager *manager;
