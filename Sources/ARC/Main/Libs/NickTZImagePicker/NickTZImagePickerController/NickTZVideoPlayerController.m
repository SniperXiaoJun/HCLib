...
@interface NickTZVideoPlayerController () {
    AVPlayer *_player;
...
@implementation NickTZVideoPlayerController
...
- (void)configMoviePlayer {
    [[NickTZImageManager manager] getPhotoWithAsset:_model.asset completion:^(UIImage *photo, NSDictionary *info, BOOL isDegraded) {
        _cover = photo;
    }];
    [[NickTZImageManager manager] getVideoWithAsset:_model.asset completion:^(AVPlayerItem *playerItem, NSDictionary *info) {
