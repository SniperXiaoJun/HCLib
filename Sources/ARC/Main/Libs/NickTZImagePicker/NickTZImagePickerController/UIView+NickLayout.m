...
+ (void)showOscillatoryAnimationWithLayer:(CALayer *)layer type:(NickTZOscillatoryAnimationType)type{
    NSNumber *animationScale1 = type == NickTZOscillatoryAnimationToBigger ? @(1.15) : @(0.5);
    NSNumber *animationScale2 = type == NickTZOscillatoryAnimationToBigger ? @(0.92) : @(1.15);
