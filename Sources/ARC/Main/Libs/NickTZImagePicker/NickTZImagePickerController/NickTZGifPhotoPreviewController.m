//
//  NickTZGifPhotoPreviewController.m
...
@interface NickTZGifPhotoPreviewController () {
    UIView *_toolBar;
    UIButton *_doneButton;
    UIProgressView *_progress;

    NickTZPhotoPreviewView *_previewView;

    UIStatusBarStyle _originStatusBarStyle;
}
@end

@implementation NickTZGifPhotoPreviewController
...
- (void)configBottomToolBar {
    ...
    [[NickTZImageManager manager] getPhotosBytesWithArray:@[_model] completion:^(NSString *totalBytes) {
...
- (void)signleTapAction {
    ...
    if (iOS7Later) {
        ...
        } else if (NickTZ_showStatusBarInitial) {
