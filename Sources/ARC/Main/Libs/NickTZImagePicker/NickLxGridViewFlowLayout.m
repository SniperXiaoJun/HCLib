...
@interface NickLxGridViewFlowLayout () <UIGestureRecognizerDelegate>

@property (nonatomic,readonly) id<NickLxGridViewDataSource> dataSource;
@property (nonatomic,readonly) id<NickLxGridViewDelegateFlowLayout> delegate;

@end

@implementation NickLxGridViewFlowLayout
{
...
- (id<NickLxGridViewDataSource>)dataSource
{
    return (id<NickLxGridViewDataSource>)self.collectionView.dataSource;
}

- (id<NickLxGridViewDelegateFlowLayout>)delegate
{
    return (id<NickLxGridViewDelegateFlowLayout>)self.collectionView.delegate;
}
...
- (void)longPressGestureRecognizerTriggerd:(UILongPressGestureRecognizer *)longPress
{
    switch (longPress.state) {
        ...
        case UIGestureRecognizerStateBegan:
        {
            ...
            NickTZTestCell *sourceCell = (NickTZTestCell *)sourceCollectionViewCell;
