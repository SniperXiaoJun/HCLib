...
@implementation UIImage (JRQRCode)
...
+ (UIImage *)qrCodeImageWithContent:(NSString *)content codeImageSize:(CGFloat)size red:(CGFloat)red green:(CGFloat)green blue:(NSInteger)blue{
    ...
    //取出图片
    CGDataProviderRef dataProvider = CGDataProviderCreateWithData(NULL, rgbImageBuf, bytesPerRow * imageHeight, JRProviderReleaseData);
...
void JRProviderReleaseData (void *info, const void *data, size_t size){
    free((void*)data);
}
